...
#ifndef MANGOS_H_CRYPTO_SHA1
#define MANGOS_H_CRYPTO_SHA1
...
namespace MaNGOS
{
    namespace Crypto
    {
        /// SHA-1 (FIPS 180-4), streaming. 20-byte digest.
        struct Sha1Traits
        {
            static constexpr size_t StateWords   = 5;
            static constexpr size_t DigestLength = 20;
        ...
        using Sha1Core = BlockHash<Sha1Traits>;
