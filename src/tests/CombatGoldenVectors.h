...
namespace golden
{
    ...
    static const MinMaxDamageVector kMinMaxDamageVectors[] =
    {
        ...
        { 0, 2.4f, 0.0f, 0.9f, 0.0f, 1.2f, 2200.0f, 120.0f, 180.0f, false, 0, true, 2600, 0.0f, 1.0f, 2.0f, 536.91425f, 601.71423f },
        { 0, 2.4f, 12.0f, 0.9f, 37.0f, 1.2f, 2200.0f, 120.0f, 180.0f, false, 0, true, 2600, 0.0f, 1.0f, 2.0f, 594.2743f, 659.0742f },
        { 0, 2.4f, 250.0f, 0.9f, -15.0f, 1.2f, 2200.0f, 120.0f, 180.0f, false, 0, true, 2600, 0.0f, 1.0f, 2.0f, 788.91425f, 853.71423f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 1, true, 1000, 0.0f, 1.0f, 2.0f, 408.5714f, 458.5714f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 1, true, 2000, 0.0f, 1.0f, 2.0f, 378.5714f, 403.5714f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 1, true, 2600, 0.0f, 1.0f, 2.0f, 371.64835f, 390.8791f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 5, true, 1000, 0.0f, 1.0f, 2.0f, 432.5714f, 502.5714f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 5, true, 2000, 0.0f, 1.0f, 2.0f, 402.5714f, 447.5714f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 5, true, 2600, 0.0f, 1.0f, 2.0f, 395.64835f, 434.8791f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 2, true, 1000, 0.0f, 1.0f, 2.0f, 408.5714f, 458.5714f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 2, true, 2000, 0.0f, 1.0f, 2.0f, 408.5714f, 458.5714f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 2, true, 2600, 0.0f, 1.0f, 2.0f, 408.5714f, 458.5714f },
        { 0, 2.4f, 12.0f, 1.0f, 0.0f, 1.0f, 1400.0f, 55.0f, 93.0f, false, 0, false, 2600, 14.0f, 1.0f, 2.0f, 253.0f, 254.0f },
        { 1, 2.4f, 12.0f, 1.0f, 0.0f, 1.0f, 1400.0f, 55.0f, 93.0f, false, 0, false, 2600, 14.0f, 1.0f, 2.0f, 253.0f, 254.0f },
        { 2, 2.4f, 12.0f, 1.0f, 0.0f, 1.0f, 1400.0f, 55.0f, 93.0f, false, 0, false, 2600, 14.0f, 1.0f, 2.0f, 253.0f, 254.0f },
        ...
        { 2, 2.8f, 12.0f, 1.0f, 0.0f, 1.0f, 1400.0f, 90.0f, 140.0f, false, 0, true, 2800, 91.5f, 1.0f, 2.0f, 638.2f, 688.2f },
        { 0, 2.4f, 12.0f, 1.0f, 0.0f, 1.0f, 1400.0f, 90.0f, 140.0f, false, 0, true, 2800, 91.5f, 1.0f, 2.0f, 342.0f, 392.0f },
        { 0, 2.4f, 40.0f, 1.0f, 0.0f, 1.0f, 1800.0f, 60.0f, 110.0f, true, 1, false, 2000, 0.0f, 1.0f, 2.0f, 378.5714f, 403.5714f },
    };
